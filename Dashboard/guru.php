...
// Definisikan variabel dari session
...
<body>
    ...
    <div class="sidebar">
        ...
        <hr class="text-white">
        <a href="guru/kirim_tugas.php">kirim Tugas</a>
        <a href="guru/daftar_tugas_selesai.php">Daftar tugas</a>
        <a href="guru/input_nilai.php">tambah nilai</a>
        <a href="guru/input_quiz.php">tambah soal quiz</a>
