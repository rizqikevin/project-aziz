...
<div class="container">
  <h2>Tambah Jadwal Tatap Muka (Guru)</h2>
  <form method="POST">
    ...
    <label>Link Jitsi Meet</label>
    <input type="url" name="link" placeholder="https://meet.jit.si/NamaKelasMapel" required>

    <label>Materi</label>
    <input type="text" name="materi">
    <a href="../guru.php" class="btn btn-secondary mb-3">Kembali ke Dashboard</a>
