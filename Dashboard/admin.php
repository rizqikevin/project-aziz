...
// Pastikan data berikut tersedia di $_SESSION
...
<body>
    ...
    <div class="sidebar">
        ...
        <hr class="text-white">
        <a href="admin/daftar_guru.php">Daftar guru</a>
        <a href="admin/daftar_siswa.php">Daftar siswa</a>
        <a href="admin/tambah_user.php">tambah user</a>
        <a href="admin/Tampil_mapel.php">tambah Mata Pelajaran</a>
        <a href="admin/pantau_siswa.php">pantau siswa</a>
        <a href="admin/statistik_user.php">statistik</a>
